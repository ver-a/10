...
### Описание проекта
#### Университетская информационная система. Проект моделирует структуру университета с факультетами, институтами, сотрудниками, курсами и проектами.
---
_1. Use Case_
---
